...
const fetchWeatherData = async () =>{
  try{
    const response= await fetch(
      `https://api.openweathermap.org/data/2.5/weather?id=${city name}&appid=${API_key}`//this is used in url fetch in my profile api in open weatherapi and change $ symabol
      );
