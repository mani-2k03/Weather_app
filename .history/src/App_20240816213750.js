...
const fetchWeatherData = async () =>{
  try{
    const response= await fetch(
      `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${API_key}&units=metric`//this is used in url fetch in my profile api in open weatherapi and change $ symbol and &units=metric is show in degree 
      );
      ...
      {weatherData &&(
          ...
          <div className='weather_data'>
            ...
            <img className='container_img' src="./image.png" width="120px" alt='thunder'></img>  
             ...
             <h2 className='container_degree'>{weatherData.temp}</h2>
