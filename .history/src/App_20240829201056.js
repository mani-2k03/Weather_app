...
const fetchWeatherData = async () =>{
  try{
    const response= await fetch(
      `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${API_key}&units=imperial`//this is used in url fetch in my profile api in open weatherapi and change $ symbol and &units=metric is show in degree crt format
      );
